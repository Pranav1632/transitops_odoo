...
// ---------- Cross-module Minimal Interfaces ----------
export type EligibleVehicle = Pick<
  Database['public']['Tables']['vehicles']['Row'],
  'id' | 'registration_number' | 'name' | 'type' | 'max_load_capacity' | 'status'
>;

export type EligibleDriver = Pick<
  Database['public']['Tables']['drivers']['Row'],
  'id' | 'name' | 'license_number' | 'license_category' | 'license_expiry' | 'status'
>;

export type VehicleForReporting = Pick<
  Database['public']['Tables']['vehicles']['Row'],
  'id' | 'registration_number' | 'name' | 'odometer' | 'acquisition_cost'
>;
