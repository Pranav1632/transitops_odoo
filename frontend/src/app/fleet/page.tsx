...
export default function FleetPage() {
  ...
  // Authorize: Only fleet_manager can view Fleet Registry
  if (profile && profile.role !== 'fleet_manager') {
    return (
      <div className="flex h-[calc(100vh-8rem)] items-center justify-center">
        <div className="max-w-md w-full border border-red-500/20 bg-red-500/5 backdrop-blur-md rounded-2xl p-6 text-center space-y-4">
          ...
          <p className="text-sm text-zinc-400">
            Only Fleet Managers are authorized to view and modify the vehicle registry.
          </p>
          <Button
