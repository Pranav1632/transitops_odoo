  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-8 shadow-sm max-w-4xl flex items-start gap-4">
        ...
        <div>
          <h3 className="text-lg font-bold text-zinc-950 dark:text-zinc-50 mb-1">Fleet Registry Page</h3>
          <p className="text-sm text-zinc-500 dark:text-zinc-400 max-w-xl leading-relaxed">
            This module (Module A) owns the registration, listing, and updates of the vehicles. It is currently being worked on by the Fleet Registry team.
          </p>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 p-6 flex items-center justify-center min-h-[300px]">
        <div className="text-center max-w-xs space-y-2">
          ...
          <p className="text-xs text-zinc-500">Vehicle CRUD forms and tables will be rendered here by Module A's implementation.</p>
        </div>
      </div>
    </div>
  );
